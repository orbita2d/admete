...
void analyse_block(std::vector<std::string> *fen_list, std::vector<int> *results, size_t start, size_t stride,
                   size_t end) {
    Board board = Board();
...
int main(int argc, char *argv[]) {
    ...
    int opt;
    while (true) {
        static struct option long_options[] = {{"summary", no_argument, &summary_flag, 1},

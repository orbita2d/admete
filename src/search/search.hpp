...
// search.cpp
score_t alphabeta(Board& board, const depth_t depth, score_t alpha, score_t beta, PrincipleLine& line, my_clock::time_point time_cutoff, bool allow_cutoff, SearchOptions& options);
score_t quiesce(Board& board, score_t alpha, score_t beta, SearchOptions& options);
score_t pv_search(Board& board, const depth_t depth, score_t alpha, score_t beta, PrincipleLine& principle, const uint pv_depth, PrincipleLine& line, my_clock::time_point time_cutoff, bool allow_cutoff, SearchOptions& options);

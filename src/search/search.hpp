...
// search.cpp
score_t alphabeta(Board& board, const depth_t depth, score_t alpha, score_t beta, PrincipleLine& line, long &nodes, my_clock::time_point time_cutoff, bool &kill_flag, bool allow_cutoff);
score_t quiesce(Board& board, score_t alpha, score_t beta, long &nodes);
score_t pv_search(Board& board, const depth_t depth, score_t alpha, score_t beta, PrincipleLine& principle, const uint pv_depth, PrincipleLine& line, long &nodes, my_clock::time_point time_cutoff, bool &kill_flag, bool allow_cutoff);

...
inline std::array<score_t, efp_max_depth+1> extended_futility_margins = {0, 200, 700};
inline std::array<score_t,rfp_max_depth+1>  reverse_futility_margins = {0, 200, 400, 800};
